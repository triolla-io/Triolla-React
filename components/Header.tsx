  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-black text-white">
      ...
      <div className="bg-yellow-400 text-black py-2 px-4 text-center text-[13px] font-medium relative flex items-center justify-center">
        <span>Pitangoux is now Triolla – We’ve rebranded! Hello and welcome!</span>
        <button className="absolute right-4 text-black hover:opacity-70" aria-label="Close">
        ...
        <div className="flex justify-between items-center h-[90px]">
          ...
          <div className="shrink-0 flex items-center">
            <Link href="/" className="flex flex-col items-center">
              ...
              <span className="text-[8px] uppercase tracking-widest text-gray-400 mt-1">Formally Pitangoux</span>
            </Link>
          </div>
          ...
          <div className="hidden lg:flex items-center gap-6">
            <Link href="/contact-us" className="border border-white/30 rounded-full px-8 py-[10px] text-[15px] font-medium hover:bg-white hover:text-black transition-all">
              Contact Us
            </Link>
            <a href="https://wa.me/+972525956644" target="_blank" rel="noreferrer" className="w-[45px] h-[45px] bg-[#25D366] rounded-full flex items-center justify-center hover:bg-green-600 transition-colors" aria-label="WhatsApp">
